export default function NeurobionPage() {
  return (
...
{/* AQUÍ PEGA EL CÓDIGO DEL PRODUCTO */}
  ...
  <div className="grid lg:grid-cols-2 gap-16 items-start">
    ...
    <div>
      ...
      <p className="text-xl text-gray-500 mb-8">
        Complejo vitamínico inyectable de alta calidad.
      </p>
...
<section className="max-w-7xl mx-auto px-8 pb-20">
  ...
  <div className="bg-white rounded-3xl shadow-xl p-10 mb-10">
    ...
    <p className="text-lg text-gray-700 leading-8">
      Neurobión DC 10000 es un complejo vitamínico inyectable que combina
      Tiamina (Vitamina B1), Piridoxina (Vitamina B6) y Cianocobalamina
      (Vitamina B12), formulado para uso profesional bajo indicación médica.
    </p>

    <p className="text-lg text-gray-700 leading-8 mt-6">
      Producto original, con presentación sellada de fábrica y distribuido
      con garantía de calidad por MEDIC FAB.
    </p>
  ...
  <div className="grid md:grid-cols-2 gap-8">
    ...
    <div className="bg-white rounded-3xl shadow-xl p-8">
      ...
      <ul className="space-y-4 text-lg text-gray-700">
        ...
        <li>✔ Caja con 3 jeringas prellenadas</li>
